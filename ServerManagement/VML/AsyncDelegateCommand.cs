...
namespace ServerManagement.VML
{
    ...
    public class AsyncDelegateCommand : AwaitableDelegateCommand<object>, IAsyncCommand
    {
    ...
    public class AwaitableDelegateCommand<T> : IAsyncCommand<T>, ICommand
    {
        ...
        private readonly MyDelegateCommand<T> _underlyingCommand;
        ...
        public AwaitableDelegateCommand(Func<T, Task> executeMethod, Func<T, bool> canExecuteMethod)
        {
            ...
            _underlyingCommand = new MyDelegateCommand<T>(x => { }, canExecuteMethod);
        }
